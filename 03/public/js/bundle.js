...
/* harmony export */   "sendBlobData": () => (/* binding */ sendBlobData)
/* harmony export */ });
...
const socket = socket_io_client__WEBPACK_IMPORTED_MODULE_0__.io();
const sendBlobData = (event, data) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "startAudioStream": () => (/* binding */ startAudioStream),
/* harmony export */   "getMediaRecorder": () => (/* binding */ getMediaRecorder),
/* harmony export */   "startMediaRecorder": () => (/* binding */ startMediaRecorder),
/* harmony export */   "stopMediaRecorder": () => (/* binding */ stopMediaRecorder)
/* harmony export */ });
...
const startAudioStream = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getMediaRecorder = (localStream) => {
...
/* harmony import */ var _socket__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./socket */ "./src/socket.ts");
...
startStreamButton.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const localStream = yield _stream__WEBPACK_IMPORTED_MODULE_0__.startAudioStream();
        const [recorder, chunks] = _stream__WEBPACK_IMPORTED_MODULE_0__.getMediaRecorder(localStream);
        startStreamButton.setAttribute('disabled', '');
        recorder.addEventListener('stop', () => {
            const blobTmp = new Blob(chunks);
            chunks.splice(0, chunks.length);
            (0,_socket__WEBPACK_IMPORTED_MODULE_1__.sendBlobData)('send', blobTmp);
        });
        _stream__WEBPACK_IMPORTED_MODULE_0__.startMediaRecorder(recorder);
        setInterval(() => {
            _stream__WEBPACK_IMPORTED_MODULE_0__.stopMediaRecorder(recorder);
            _stream__WEBPACK_IMPORTED_MODULE_0__.startMediaRecorder(recorder);
        }, 1000);
    }
    catch (err) {
...
_socket__WEBPACK_IMPORTED_MODULE_1__.socket.on('update', (data) => {
    let audio = document.createElement('audio');
    const blobTmp = new Blob([data]);
    const url = URL.createObjectURL(blobTmp);
    audio.src = url;
    audio.play();
